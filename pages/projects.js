    ...
    <div className="px-5 lg:px-32 xl:px-52 pt-20 pb-10 xl:pt-28 bg-gray-200">
      ...
      <div className="flex flex-wrap justify-center mt-8">
          <div className="relative m-3 details">
            <div className="w-64 md:w-72 xl:w-80 h-56 md:h-64 p-5 bg-yellow-500 flex flex-col items-center space-y-3">
        ...
        <div className="relative m-3 details">
            <div className="w-64 md:w-72 xl:w-80  h-56 md:h-64 p-5 bg-red-400 flex flex-col items-center space-y-3">
        ...
        <div className="relative m-3 details">
            <div className="w-64 md:w-72 xl:w-80 h-56 md:h-64  p-5 bg-pink-400 flex flex-col items-center space-y-3">
        ...
        <div className="relative m-3 details">
            <div className="w-64 md:w-72 xl:w-80 h-56 md:h-64  p-5 bg-yellow-300 flex flex-col items-center space-y-3">
                <div className="w-2/5"><img src="/assets/live-chat.png" alt=""  /></div>    
